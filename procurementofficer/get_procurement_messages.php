...
try {
    // Mark procurement messages as read - update messages where current user is the receiver
    $updateStmt = $con->prepare("UPDATE pm_procurement_messages SET is_read = 1 WHERE ((sender_id = ? AND receiver_id = ?) OR (sender_id = ? AND receiver_id = ?)) AND is_read = 0");
