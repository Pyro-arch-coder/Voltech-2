                                        ...
                                        <?php foreach ($projects as $project): ?>
                                            <tr>
                                                ...
                                                <td class="text-nowrap">
                                                  <a class="btn btn-outline-primary btn-sm" href="client_process.php?project_id=<?php echo $project['project_id']; ?>" onclick="console.log('Navigating to project_process.php with project_id=<?php echo $project['project_id']; ?>')"> 
