...
// Fetch supplier notifications and show user name and notif_type only
$sql = "SELECT n.user_id, n.notif_type, u.firstname, u.lastname FROM notifications_supplier n JOIN users u ON n.user_id = u.id ORDER BY n.created_at DESC LIMIT 20";
$res = $con->query($sql);
if ($res && $res->num_rows > 0) {
    ...
    echo '<div class="alert alert-info">No supplier notifications found.</div>';
}
?> 